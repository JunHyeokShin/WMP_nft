      ...
      <form onSubmit={(e) => handleCreateListing(e)}>
        <div className={css.container}>
          <div className={css.collectionContainer}>
            <Stack
              className={css.boxBorder}
              minH={"50vh"}
              h={{ base: "-webkit-fill-available", md: 435 }}
            ...
            >
              ...
              <Flex p={4} flex={1} align={"center"} justify={"center"}>
                <Stack
                  ...
                  w={"full"}
                  maxW={"md"}
                  h={{ base: "-webkit-fill-available", md: 380 }}
                >
                  <h1 className={css.ourCollection}>Upload your NFT</h1>
                  <input
                    type="file"
                  ...
                  <div className={css.none}>
                    ...
                    <label
                      ...
                      className={css.listingTypeLabel}
                    >
                      Direct Listing
                    </label>
                    <input
                      ...
                      {({ isOpen, onClose }) => (
                        <>
                          ...
                          <PopoverContent>
                            ...
                            <PopoverCloseButton />
                            <PopoverBody>
                              There will be at least 2 to 3 transactions for NFT
                              uploads, do you agree?
                            </PopoverBody>
                            <PopoverFooter
                              display="flex"
